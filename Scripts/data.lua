...
local nodes_comments = {
    ...
    ["container_woodcrate_VOTV"] = "WoodCrate_VOTV_01, WoodCrate_VOTV_02, WoodCrate_VOTV_03 - (woodplank, gigaglue, pipe_metal, ducttape, flashlight_basic, scrap_cloth, acid, enethiol, votv_harddrive, votv_plunger, sensor, keyboard, scrap_tech)",
    ...
    ["resourcenode_backpack_security"] = "MicroNode_BackpackHiking, MicroNode_SecurityBackpack - (backpack_security)",
    ...
    ["resourcenode_elfhat"] = "MicroNode_ElfHat - (armor_hat_elf)",
    ["resourcenode_enethiol"] = "MicroNode_Enethiol - (enethiol)",
    ["resourcenode_essence_frozen"] = "Micronode_KrasueEssence - (essence_frozen)",
    ["resourcenode_essence_frozen_2x"] = "Micronode_KrasueEssence_TWO - (essence_frozen)",
    ["resourcenode_essence_leyak"] = "Micronode_LeyakEssence - (essence_leyak)",
    ["resourcenode_essence_leyak_2x"] = "Micronode_LeyakEssence_TWO - (essence_leyak)",
    ...
    ["resourcenode_gardenwreath"] = "MicroNode_GardenWreath - (armor_helmet_wreathcrown)",
    ...
    ["resourcenode_greekarmor_arms"] = "MicroNode_GreekArmor_Arms - (armor_arms_greek)",
    ["resourcenode_greekarmor_chest"] = "MicroNode_GreekArmor_Chest - (armor_chest_greek)",
    ["resourcenode_greekarmor_legs"] = "MicroNode_GreekArmor_Legs - (armor_legs_greek)",
    ["resourcenode_greekhelmet"] = "MicroNode_GreekHelmet - (armor_helmet_greek)",
    ["resourcenode_gymbench"] = "GymEquipment_Bench - (scrap_cloth, scrap_metal)",
    ["resourcenode_gymbike"] = "GymEquipment_Bike - (scrap_cloth, scrap_metal, scrap_tech, scrap_plastic)",
    ["resourcenode_hammer"] = "MicroNode_Hammer - (hammer)",
    ["resourcenode_hardhat"] = "MicroNode_HardHat - (armor_helmet_hardhat)",
    ["resourcenode_hastaboots"] = "HastaTriaBoots - (fig_hastaboot, trinket_hastaboot)",
    ...
    ["resourcenode_jesterhat"] = "MicroNode_JesterHat - (armor_hat_jester)",
    ...
    ["resourcenode_votv_ShrimpPacket"] = "MicroNode_VOTV_ShrimpsPack - (food_votv_shrimpspack_raw)",
    ["resourcenode_votv_chinesefood"] = "MicroNode_VOTV_ChineseTakeaway - (food_votv_chinesefood)",
    ["resourcenode_votv_hamburger"] = "MicroNode_VOTV_Hamburger - (food_votv_hamburger)",
    ["resourcenode_votv_journal"] = "MicroNode_VOTV_SunBook - (votv_journal_01)",
    ["resourcenode_waxtablet_01"] = "MicroNode_WaxTablet1 - (tablet_wax_01)",
    ["resourcenode_waxtablet_02"] = "MicroNode_WaxTablet2 - (tablet_wax_02)",
    ["resourcenode_waxtablet_03"] = "MicroNode_WaxTablet3 - (tablet_wax_03)",
    ...
    ["salvage_1metalscrap"] = "GymEquipment_Dumbbell, MetalVent - (scrap_metal)",
    ...
    ["salvage_3metalscrap"] = "GymEquipment_Barbell - (scrap_metal)",
    ["salvage_4glassscrap"] = "ReceptorHousing - (scrap_glass)",
    ["salvage_backpack_signal"] = "MicroNode_VOTV_Backpack - (backpack_votv_small)",
...
local drops_comments = {
    ...
    ["Snowman"] = "Snowman - (food_carrot, armor_hat_snowman, armor_helmet_scarf, snowball, hexwood)",
}
...
local corpse_comments = {
    ...
    ["Peccary_Volatile"] = "Volatile Peccary - (gib_peccary_leg, gib_peccary_skull_volatile, gib_peccary_chop, blood_plutonic, carapace_plutonic)",
    ...
    ["Skink"] = "Skink - (gib_skink_skull, gib_meat_skink, greenliver, fishbones, fish_rad)",
    ...
    ["Skink_Crafted"] = "Skink - (gib_skink_skull, gib_meat_skink, greenliver, fishbones, fish_rad)",
    ...
    ["Peccary_Snow"] = "Snow Peccary - (gib_peccary_leg, gib_peccary_chop, yetifur, gib_peccary_furry_skull)",
    ["PowerLeech_BOSS"] = "Power Leech - (powderedcrystal, circuitboard)",
    ["Pest_Snow"] = "Snow Pest - (gib_pest_body, gib_pest_tail, yetifur)",
    ...
    ["Peccary_Armored"] = "Tareccary - (gib_peccary_leg, gib_peccary_skull, gib_peccary_chop)",
    ["Pest_Magma"] = "Magma Pest - (food_pest_body_burnt, food_pest_tail_burnt, gel)",
    ["Pest_Enlightened"] = "Enlightened Pest - (gib_pest_body, gib_pest_tail)",
    ["Pest_Leyak"] = "Leyak Pest - (gib_pest_body, gib_pest_tail, capacitor, scrap_tech)",
    ["Peccary_Electro"] = "Electro Peccary - (gib_peccary_leg, gib_peccary_skull, gib_peccary_chop)",
    ["Pest_Rat"] = "Rattus Pestis - (gib_pest_body, gib_pest_tail)",
...
local fish_comments = {
    ["Antefish"] = "Most Water",
    ["Antefish_rare1"] = "Most Water",
    ["Fogfish"] = "Fog Swirls",
    ["Fogfish_rare1"] = "Fog Swirls",
    ["Portalfish"] = "Antejuice Pools",
    ["Portalfish_rare1"] = "Antejuice Pools",
    ["Portalfish_rare2"] = "Some Distant Shore",
    ["Radfish"] = "Radioactive Waste",
    ["Radfish_rare1"] = "Radioactive Waste",
    ["IS0098"] = "Most Water",
    ["IS0098_rare1"] = "Most Water",
    ["ReaperFish"] = "Inky Pools",
    ["ReaperFish_rare1"] = "Inky Pools",
    ["DarkwaterFish"] = "Darkwater",
    ["DarkwaterFish_rare1"] = "Darkwater",
    ["MoonFish"] = "Low-Light Pools",
    ["MoonFish_rare1"] = "Low-Light Pools",
    ["MoonFish_AllDay"] = "",
    ["MoonFish_rare1_AllDay"] = "",
    ["Eel"] = "Eel-Infested Waters",
    ["Eel_rare1"] = "Eel-Infested Waters",
    ["Eel_rare2"] = "Eel-Infested Waters",
    ["Eel_rare3"] = "Eel-Infested Waters",
    ["IceFish"] = "IS-0083",
    ["IceFish_rare1"] = "IS-0083",
    ["SilkFish"] = "Power Services",
    ["SilkFish_rare1"] = "Power Services",
    ["UmbraFish"] = "Shadowgate",
    ["UmbraFish_rare1"] = "Shadowgate",
    ["GemCrab"] = "The Encroachment",
    ["GemCrab_rare1"] = "The Encroachment",
    ["Portalfish_rare_torii"] = "Torii",
    ["VOTV_Rudd"] = "Dunkeltaler Forest",
}
